<?php  
  if (!isset($_SESSION['SCHOOLID'])){
   ...
   $agencyID = isset($_GET['id']) ? $_GET['id'] :''; 
    ...
    $sql = "SELECT * FROM `tblcompany` c, `tblrequest` r WHERE c.COMPANYID=r.`AgencyID` AND RequestID='$requestID'";
    $mydb->setQuery($sql);
                  ...
                  <h5>Agency Details</h5>
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src="<?php echo web_root.'agency/user/'. $singleRequest->Img1; ?>" alt="">
                        <span class="username">
                ...
                <tbody>
                  ...
                  foreach ($cur as $row) {
                      ...
                      if ($row->Status=='Pending') {
                        ...
                        <a title="Dowload Attachment" href="'.$row->SchoolAttachment.'" target="_blank"  class="btn btn-success btn-sm"><i class="fa fa-eye"></i> Document</a></td>';
                      }else{ 
                        echo '<td align="center">
