...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">JOb Vacancy<!-- <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Add Job Vacancy</a> -->  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				  	...
				  	<?php 
				  	 // `COMPANYID`, `OCCUPATIONTITLE`, `REQ_NO_EMPLOYEES`, `SALARIES`, `DURATION_EMPLOYEMENT`, `QUALIFICATION_WORKEXPERIENCE`, `JOBDESCRIPTION`, `PREFEREDSEX`, `SECTOR_VACANCY`, `JOBSTATUS`
						...
						foreach ($cur as $result) {
				  		...
				  		//      <a title="Post Online" href="controller.php?action=posted&id='.$result->JOBID.'" class="btn btn-success btn-xs  ">  <span class="fa  fa-check fw-fa "></a></td>';
				  			if ($result->JOBSTATUS=='Approved') {
				  				# code...
				  			  echo '<td align="center"><a title="View" href="index.php?view=edit&id='.$result->JOBID.'" class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></a></td>';
				  			}else if ($result->JOBSTATUS=='Posted Online') {
				  			   echo '<td align="center"><a title="View" href="index.php?view=edit&id='.$result->JOBID.'" class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></a>
				  		         <a title="Close Job Vacancy" href="controller.php?action=close&id='.$result->JOBID.'" class="btn btn-danger btn-xs  ">  <span class="fa fa-times fw-fa"></a></td>';
				  		    }else if ($result->JOBSTATUS=='Job Vacancy Closed') {
				  			   // echo '<td align="center"><a title="View" href="index.php?view=edit&id='.$result->JOBID.'" class="btn btn-primary btn-xs  ">  <span class="fa fa-edit fw-fa"></a>
				  		    //      <a title="Open Job Vacancy" href="controller.php?action=open&id='.$result->JOBID.'" class="btn btn-danger btn-xs  ">  <span class="fa fa-times fw-fa"></a></td>';
				  				echo '<td>-</td>';
				  			}else{
				  				echo '<td>-</td>';
