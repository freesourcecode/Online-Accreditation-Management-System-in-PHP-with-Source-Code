...
defined('SITE_ROOT') ? null : define ('SITE_ROOT', $_SERVER['DOCUMENT_ROOT'].DS.'AccreditationSystem');
...
require_once(LIB_PATH.DS."schoolrequest.php");  
require_once(LIB_PATH.DS."requestdocuments.php");  
