...
<!-- 
                 <div class="form-group">
                  ...
                  <?php 
                      $sql ="Select * From tblcompany WHERE COMPANYID=8";
                      $mydb->setQuery($sql);
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <button type="submit" name="post" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span>&nbsp;<strong>Save and Post Online</strong></a>
