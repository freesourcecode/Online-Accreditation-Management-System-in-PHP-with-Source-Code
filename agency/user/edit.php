                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="U_ROLE" id="U_ROLE">
                          ...
                          <option value="President"  <?php echo ($singleuser->ROLE=='President') ? 'selected="true"': '' ; ?>  >President</option>   
                          <option value="Office Head"  <?php echo ($singleuser->ROLE=='Office Head') ? 'selected="true"': '' ; ?>>Office Head</option>  
                          <option value="HR"  <?php echo ($singleuser->ROLE=='HR') ? 'selected="true"': '' ; ?> >HR</option>  
                          <option value="PSB"  <?php echo ($singleuser->ROLE=='PSB') ? 'selected="true"': '' ; ?> >PSB</option>  
                        </select> 
                      </div>
                    </div>
                  </div>
